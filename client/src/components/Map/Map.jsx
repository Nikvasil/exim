...
const Map = ({
    ...
    >
        ...
        {user && favouriteFacility && (<Marker
            key="favouriteFacility"
            position={[favouriteFacility.Y, favouriteFacility.X]}
        ...
        {selectedFacility && showDetails && <CenterMap center={[selectedFacility.Y + 0.008, selectedFacility.X]}/>}
        {user && selectedFacility && showRoute && (<RoutingMachine
